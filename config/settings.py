...
SECRET_KEY = 'b&(q9y31el&up%&cczjh8+kto&o7gjgr&on+0sur7$k^jn-o4p'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'onlineshop',
        'USER': 'root',
        'PASSWORD': 'quqbrk12!!',  # !!! 자신의 비밀번호로 변경
...
IAMPORT_SECRET = 'ujul5nloJ8cNirfxtjbaUUqqEWdiXdoswTOCh901icPBE488okjjeJJSFWbD9z6GtUiL4iMmvBYaG6j4'
